...
/*   Updated: 2026/08/12 15:22:53 by nipichon         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static long long	ft_exit_atoll_calc(int neg, int i, char *str, int *overflow)
{
...
static long long	ft_exit_atoll(char *str, int *overflow)
{
	...
	*overflow = 0;
	...
	res = ft_exit_atoll_calc(neg, i, str, overflow);
	return ((long long)res);
}
